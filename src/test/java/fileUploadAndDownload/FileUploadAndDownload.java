...
public class FileUploadAndDownload {
	...
	{
		File myfile=new File("C:\\Automation\\jsonfiles\\test1.txt");
	...
	{
		File myfile1=new File("C:\\Automation\\jsonfiles\\test1.txt");
		File myfile2=new File("C:\\Automation\\jsonfiles\\test2.txt");
